...
- **Brier score:** 0.1712 (lower is better; 0 is perfect, 0.25 is uninformative)
- **Expected calibration error:** 0.012 (lower is better)

### Is this better than guessing?

- Label base rate: **0.209**
- A constant predictor (base rate for everyone) scores Brier **0.1653**
- Brier skill score: **-0.0354** — this model **does NOT beat** the constant predictor.
- Properties with any flood signal: **1441** of 3980
