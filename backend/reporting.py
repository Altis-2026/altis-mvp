...
def build_event_report(event_id: str, df, stats: dict) -> bytes:
    ...
    elems.append(Paragraph(
        "Generated by Altis · Real-time satellite ground truth for carrier claims "
        "operations and MGA portfolio management. Decisions support, not replace, "
        "licensed adjuster judgment.", small))
...
def build_cat_report(portfolio_id: str, results: list, meta: dict,
    ...
    elems.append(Paragraph(
        "Generated by Altis · Real-time satellite ground truth for carrier claims "
        "operations and MGA portfolio management. Loss figures are satellite-derived "
        "estimates for reserving support, not adjusted claims.", small))
